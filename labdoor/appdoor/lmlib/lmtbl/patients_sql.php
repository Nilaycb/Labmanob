...
$db_tables['patients']['query'] = "CREATE TABLE `patients` (`id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, 
...
$db_tables['patients']['name'] = "patients";

$db_tables['patients']['fields'] = array(
        'id' => array(
            'type' => 'INT',
            'constraint' => 11,
            'unsigned' => TRUE,
