...
<div class="uk-width-1-4 uk-padding-small">
    ...
    <div class="uk-panel uk-overflow-hidden uk-margin-small uk-card uk-card-default uk-card-small uk-width-expand"> 
        <div class="uk-card-header"> 
            <div class="uk-grid-small uk-flex-wrap uk-flex-middle" uk-grid> 
                <div class="uk-width-auto"> 
                    <img class="uk-border-circle uk-responsive-width" src="<?php echo assets_url().'uploads/logo/ncd-logo.png'; ?>"> 
                </div> 
                <div class="uk-width-expand"> 
                    <h3 class="uk-card-title uk-margin-remove-bottom">Niramoy Clinic & Diagnosis</h3> 
        ...
        <div class="uk-card-footer">
            ...
            <?php 
            if ( (!empty($summary)) && ( (!empty($summary['total'])) || (!empty($summary['today'])) || (!empty($summary['lastday'])) ) ) 
            { 
                ...
                if (!empty($summary['total']) && ($_SESSION['username'] == 'master')) 
                { 
                    echo '<div class="uk-margin-small">'; 
