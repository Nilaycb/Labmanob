...
<div class="uk-width-expand uk-padding-small">
    ...
    <div class="uk-panel uk-margin-small uk-card uk-card-default uk-card-small uk-width-expand">
        ...
        <div class="uk-card-header">
            <h3 class="uk-card-title"> Test Categories</h3> 
        </div>
        <div class="uk-card-body">
            ...
            <form id="view_test_categories_form" action="<?php echo site_url('labmanob/view/test_categories'); ?>" method="get" accept-charset="utf-8">
        ...
        <?php if ((isset($test_categories_table)) && (!$test_categories_table_empty)) { ?>
        <div class="uk-card-footer">
            <div class="uk-margin-small">

                <?php if(isset($page) && ($page != '')): ?>
                <form id="view_test_categories_generate_form" action="<?php echo site_url('labmanob/view/test_categories/'.$page); ?>" method="get" accept-charset="utf-8">
                <?php else: ?>
                <form id="view_test_categories_generate_form" action="<?php echo site_url('labmanob/view/test_categories'); ?>" method="get" accept-charset="utf-8">
                <?php endif; ?>
    ...
    <div class="uk-margin">
        <h3>Test Categories List</h3> 
        <?php echo (isset($total_results)) ? '<span class="uk-text-meta"> Total '.$total_results.' test categories.</span>' : '' ; ?>
        <div class="uk-margin-small">
            <?php 
            if ((isset($test_categories_table)) && (!$test_categories_table_empty)) 
            { 
                echo '<div class="uk-overflow-auto">'; 
                echo $test_categories_table; 
                echo '</div>'; 
            } 
            else 
            { 
