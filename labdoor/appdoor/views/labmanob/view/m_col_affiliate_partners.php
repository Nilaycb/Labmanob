...
<div class="uk-width-expand uk-padding-small">
    ...
    <div class="uk-panel uk-margin-small uk-card uk-card-default uk-card-small uk-width-expand">
        ...
        <div class="uk-card-header">
            <h3 class="uk-card-title"> Affiliate Partners</h3> 
        </div>
        <div class="uk-card-body">
            ...
            <form id="view_affiliate_partners_form" action="<?php echo site_url('labmanob/view/affiliate_partners'); ?>" method="get" accept-charset="utf-8">
            ...
            <div class="uk-margin">
                <div class="uk-margin">
                    <?php 
                    echo form_submit('submit_view_affiliate_partners', 'View', array('class' => 'uk-button uk-button-primary uk-margin-small-right uk-align-left uk-margin-remove-bottom')); 
                    
                    echo form_button('reset_view_affiliate_partners', 'Reset', array('class' => 'uk-button uk-button-default uk-margin-small-left uk-align-right uk-margin-remove-bottom', 'id' => 'reset_view_affiliate_partners_form')); 
                    ?>
                </div>
            </div>
        ...
        <?php if ((isset($affiliate_partners_table)) && (!$affiliate_partners_table_empty)) { ?>
        <div class="uk-card-footer">
            <div class="uk-margin-small">

                <?php if(isset($page) && ($page != '')): ?>
                <form id="view_affiliate_partners_generate_form" action="<?php echo site_url('labmanob/view/affiliate_partners/'.$page); ?>" method="get" accept-charset="utf-8">
                <?php else: ?>
                <form id="view_affiliate_partners_generate_form" action="<?php echo site_url('labmanob/view/affiliate_partners'); ?>" method="get" accept-charset="utf-8">
                <?php endif; ?>
    ...
    <div class="uk-margin">
        <h3>Affiliate Partners List</h3> 
        <?php echo (isset($total_results)) ? '<span class="uk-text-meta"> Total '.$total_results.' affiliate partners.</span>' : '' ; ?>
        <div class="uk-margin-small">
            <?php 
            if ((isset($affiliate_partners_table)) && (!$affiliate_partners_table_empty)) 
            { 
                echo '<div class="uk-overflow-auto">'; 
                echo $affiliate_partners_table; 
                echo '</div>'; 
            } 
            else 
            { 
                echo 'No affiliate partner found.'; 
            } 
            ?>
        </div>
        <div class="uk-margin-small">
    ...
    <script>
		...
		{
            $('#reset_view_affiliate_partners_form').click(function()
            {
