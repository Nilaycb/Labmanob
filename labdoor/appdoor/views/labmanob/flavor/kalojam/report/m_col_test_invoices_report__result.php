...
<div class="uk-width-expand uk-padding-small">
    ...
    <div class="uk-panel uk-margin-small uk-card uk-card-default uk-card-small uk-width-expand">
        ...
        <div class="uk-card-header">
            <h3 class="uk-card-title"><span uk-search-icon></span> Test Invoices Report</h3> 
        </div>
        <div class="uk-card-body">
            ...
            <form id="search_test_invoices_form" action="<?php echo site_url('labmanob/flavor/kalojam/report/test_invoices_report/view'); ?>" method="get" accept-charset="utf-8">
            ...
            <div class="uk-margin">
                ...
                <div class="uk-inline">
                    <?php 
                    echo form_input('results_per_page', set_value('results_per_page', 50), array('class' => 'uk-input uk-form-width-large uk-form-large', 'placeholder' => 'Results Per Page', 'maxlength' => '11', 'id' => 'results_per_page'));
                    ?>
                </div>
            </div>
        ...
        <?php if ((isset($test_invoices_table)) && (!$test_invoices_table_empty)) { ?>
        <div class="uk-card-footer">
            <div class="uk-margin-small">

                <?php if(isset($page) && ($page != '')): ?>
                <form id="search_test_invoices_generate_form" action="<?php echo site_url('labmanob/flavor/kalojam/report/test_invoices_report/view/'.$page); ?>" method="get" accept-charset="utf-8">
                <?php else: ?>
                <form id="search_test_invoices_generate_form" action="<?php echo site_url('labmanob/flavor/kalojam/report/test_invoices_report/view'); ?>" method="get" accept-charset="utf-8">
                <?php endif; ?>

                <?php
                echo form_hidden('test_invoice_id', set_value('test_invoice_id'));
                echo form_hidden('patient_id', set_value('patient_id'));
                echo form_hidden('ref_by', set_value('ref_by'));
                echo form_hidden('affiliate_partner_id', set_value('affiliate_partner_id'));
                echo form_hidden('begin_date', set_value('begin_date'));
                echo form_hidden('end_date', set_value('end_date'));
                echo form_hidden('payment_status', set_value('payment_status', 'all'));
    ...
    <div class="uk-margin">
        ...
        <div class="uk-margin-small">
            ...
            { 
                echo 'No test invoice report found.'; 
            } 
            ?>
        </div>
        <div class="uk-margin-small">
