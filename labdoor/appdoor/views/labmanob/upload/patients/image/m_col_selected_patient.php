...
<div class="uk-width-expand uk-padding-small">
    ...
    <div class="uk-margin-small uk-panel uk-card uk-card-default uk-card-small uk-width-expand">
        ...
        <div class="uk-card-footer">
            <div class="uk-margin-small">
                <?php 
                echo anchor('labmanob/upload/patient_image/remove_patient', 'Remove', array ('class' => 'uk-button uk-button-danger uk-margin-small-right uk-align-left uk-margin-remove-bottom')); 
                
                if(isset($redirect_to_add_new_test_invoice) && ($redirect_to_add_new_test_invoice == TRUE))
                {
                    echo anchor('labmanob/upload/patient_image/redirect_to_add_new_test_invoice', 'Next', array ('class' => 'uk-button uk-button-default uk-margin-small-left uk-align-right uk-margin-remove-bottom')); 
                }
                else if(isset($_SESSION['upload_patient_image__redirect_to_add_new_test_invoice']) && ($_SESSION['upload_patient_image__redirect_to_add_new_test_invoice'] != ''))
                {
                    echo anchor('labmanob/upload/patient_image/redirect_to_add_new_test_invoice', 'Next', array ('class' => 'uk-button uk-button-default uk-margin-small-left uk-align-right uk-margin-remove-bottom')); 
                }
                else 
                {
                    echo anchor('labmanob/upload/patient_image/finish', 'Finish', array ('class' => 'uk-button uk-button-default uk-margin-small-left uk-align-right uk-margin-remove-bottom')); 
                }
                ?>
            </div>
        </div>
    ...
    <div class="uk-margin-small uk-panel uk-card uk-card-default uk-card-small uk-width-expand">
        ...
        <div class="uk-card-body">
            ...
            if ($this->session->flashdata('message_redirect_to_add_new_test_invoice')) 
            {
                echo '<div class="uk-alert-primary" uk-alert><a class="uk-alert-close" uk-close></a>'. $this->session->flashdata('message_redirect_to_add_new_test_invoice') .'</div>';
                if (isset($_SESSION['message_redirect_to_add_new_test_invoice'])) { unset($_SESSION['message_redirect_to_add_new_test_invoice']); }
            }
            ...
            <?php 
            echo form_open_multipart('labmanob/upload/patient_image/upload_image', array('id' => 'upload_image_form')); 
            ?>
        ...
        <div class="uk-card-footer" id="upload_image_card_footer">
            ...
            <div class="uk-margin-small">
                <?php 
                echo anchor('labmanob/upload/patient_image', '<span class="" uk-icon="refresh"></span> Refresh', array ('class' => 'uk-button uk-button-default uk-margin-small-right uk-align-left uk-margin-remove-bottom')); 
    ...
    $(document).ready(function() 
	{
        ...
        var redirect_to_add_new_test_invoice = false;
        var redirect_second = 5;
        ...
        function uikit_upload_setup() {
            ...
            url: '<?php echo site_url('labmanob/upload/patient_image/upload_image_xmlhttprequest'); ?>',
            multiple: false,
            name: 'image_file',
            ...
            complete: function () {
                ...
                if( (response != null) && response.hasOwnProperty('upload_success') && (response.upload_success == true) && response.hasOwnProperty('message_display') && response.hasOwnProperty('uploaded_image_data') && response.uploaded_image_data.hasOwnProperty('file_name') && response.uploaded_image_data.hasOwnProperty('file_type') && (response.hasOwnProperty('encoded_image_data') || response.hasOwnProperty('upload_dir')) )
                {
                    ...
                    if(response.hasOwnProperty('redirect_to_add_new_test_invoice') && (response.redirect_to_add_new_test_invoice == true) && response.hasOwnProperty('redirect_second') && response.hasOwnProperty('message_redirect_to_add_new_test_invoice'))
                    {
                        message_container.innerHTML += '<div class="uk-alert-primary" uk-alert><a class="uk-alert-close" uk-close></a> '+response.message_redirect_to_add_new_test_invoice+'</div>';
                        <?php /* $('#upload_image_card_footer div:first').append('<a href="<?php echo site_url('labmanob/add/new_test_invoice'); ?>" class="uk-button uk-button-default uk-margin-small-left uk-align-right uk-margin-remove-bottom">Next</a>'); */; ?>

                        redirect_to_add_new_test_invoice = response.redirect_to_add_new_test_invoice;
                        redirect_second = response.redirect_second;
                    }
                    else 
                    {
                        <?php /* $('#upload_image_card_footer div:first').append('<a href="<?php echo site_url('labmanob/upload/patient_image/finish'); ?>" class="uk-button uk-button-default uk-margin-small-left uk-align-right uk-margin-remove-bottom">Finish</a>'); */; ?>
                    }
            ...
            completeAll: function () {
                ...
                if(redirect_to_add_new_test_invoice == true) 
                {
                    <?php
                    ...
                    setTimeout(function () {
                        window.location.href = "<?php echo site_url('labmanob/add/new_test_invoice'); ?>";
