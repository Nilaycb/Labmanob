...
<div class="uk-width-expand uk-padding-small">
    ...
    <div>
        ...
        <div class="uk-margin-small">
            ...
            if ($this->session->flashdata('message_upload_patient_image')) 
            {
            echo '<div class="uk-alert-primary" uk-alert><a class="uk-alert-close" uk-close></a>'. $this->session->flashdata('message_upload_patient_image') .'</div>';
            }
            
            if ($this->session->flashdata('message_add_to_test_invoice')) 
            {
            echo '<div class="uk-alert-primary" uk-alert><a class="uk-alert-close" uk-close></a>'. $this->session->flashdata('message_add_to_test_invoice') .'</div>';
            }
            ...
            <?php 
            echo form_open('labmanob/add/new_patient'); 
            ?>
            ...
            <div class="uk-margin">
                <div class="uk-inline">
                    <?php 
                    echo form_checkbox('upload_patient_image', 'yes', set_checkbox('upload_patient_image', 'yes', FALSE), array('class' => 'uk-checkbox', 'id' => 'upload_patient_image')); 
                    echo form_label('Upload patient image', 'upload_patient_image', array('class' => 'uk-form-label uk-margin-small-left uk-margin-small-right')); 
                    ?>
                </div>
            </div>
            ...
            <div class="uk-margin">
                <div class="uk-inline">
                    <?php 
                    echo form_checkbox('add_to_test_invoice', 'yes', set_checkbox('add_to_test_invoice', 'yes', TRUE), array('class' => 'uk-checkbox', 'id' => 'add_to_test_invoice')); 
                    echo form_label('Add this patient to new test invoice', 'add_to_test_invoice', array('class' => 'uk-form-label uk-margin-small-left uk-margin-small-right')); 
                    ?>
                </div>
            </div>
