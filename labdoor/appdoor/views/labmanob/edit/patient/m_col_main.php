...
<div class="uk-width-expand uk-padding-small">
    ...
    <div class="uk-margin-small uk-panel uk-card uk-card-default uk-card-small uk-width-expand">
        ...
        <?php 
		echo form_open('labmanob/edit/patient/index/'.$patient->id);
		?>

        <div class="uk-card-header">
            <h3 class="uk-card-title">Edit Patient</h3> 
        </div>
        <div class="uk-card-body">
            ...
            <div class="uk-margin">
                ...
                <div class="uk-inline">
                    <?php 
                    echo form_input('firstname', set_value('firstname', $patient->firstname), array('class' => 'uk-input uk-form-width-large uk-form-large', 'placeholder' => 'First Name', 'maxlength' => '150'));
                    ?>
                </div>
            </div>
            ...
            <div class="uk-margin">
                ...
                <div class="uk-inline">
                    <?php 
                    echo form_input('lastname', set_value('lastname', $patient->lastname), array('class' => 'uk-input uk-form-width-large uk-form-large', 'placeholder' => 'Last Name', 'maxlength' => '150'));
                    ?>
                </div>
            </div>
            ...
            <div class="uk-margin">
                ...
                <div class="uk-inline">
                    <?php 
                    echo form_dropdown('sex', $options, array($patient->sex), array('class' => 'uk-select uk-form-width-large uk-form-large')); 
                    ?>
                </div>
            </div>
            ...
            <div class="uk-margin">
                ...
                <div class="uk-inline">
                    <?php 
                    echo form_input('phone_no', set_value('phone_no', $patient->phone_no), array('class' => 'uk-input uk-form-width-large uk-form-large', 'placeholder' => 'Phone', 'maxlength' => '100'));
                    ?>
                </div>
            </div>
            ...
            <div class="uk-margin">
                ...
                <div class="uk-inline">
                    <?php 
                    echo form_input('email', set_value('email', $patient->email), array('class' => 'uk-input uk-form-width-large uk-form-large', 'placeholder' => 'Email', 'maxlength' => '150'));
                    ?>
                </div>
            </div>
            ...
            <div class="uk-margin">
                ...
                <div class="uk-inline">
                    <?php 
                    echo form_input('current_address', set_value('current_address', $patient->current_address), array('class' => 'uk-input uk-form-width-large uk-form-large', 'placeholder' => 'Current Address', 'maxlength' => '255'));
                    ?>
                </div>
            </div>
            ...
            <div class="uk-margin">
                ...
                <div class="uk-inline">
                    <?php 
                    echo form_input('current_city', set_value('current_city', $patient->current_city), array('class' => 'uk-input uk-form-width-large uk-form-large', 'placeholder' => 'Current City', 'maxlength' => '50'));
                    ?>
                </div>
            </div>
            ...
            <div class="uk-margin">
                ...
                <div class="uk-inline">
                    <?php 
                    echo form_input('permanent_address', set_value('permanent_address', $patient->permanent_address), array('class' => 'uk-input uk-form-width-large uk-form-large', 'placeholder' => 'Permanent Address', 'maxlength' => '255'));
                    ?>
                </div>
            </div>
            ...
            <div class="uk-margin">
                ...
                <div class="uk-inline">
                    <?php 
                    echo form_input('permanent_city', set_value('permanent_city', $patient->permanent_city), array('class' => 'uk-input uk-form-width-large uk-form-large', 'placeholder' => 'Permanent City', 'maxlength' => '50'));
                    ?>
                </div>
            </div>
            ...
            <div class="uk-margin">
                ...
                <div class="uk-inline">
                    <?php 
                    echo form_textarea(array('name' => 'extra_info', 'rows' => '5'), set_value('extra_info', $patient->extra_info), array('class' => 'uk-textarea uk-form-width-large uk-form-large', 'placeholder' => 'Extra Information', 'maxlength' => '255'));
                    ?>
                </div>
            </div>
        </div>
        <div class="uk-card-footer">
            <div class="uk-margin-small">
                <?php 
                echo anchor('labmanob/view/patient/'.$patient->id, 'Back', array ('class' => 'uk-button uk-button-default uk-margin-small-right uk-align-left uk-margin-remove-bottom')); 
