            ...
            animate: function animate(action) {
                ...
                return new uikitUtil.Promise(function (resolve) {
                    ...
                    this$1._raf = requestAnimationFrame(function () {
                        ...
                        var newHeight = uikitUtil.height(this$1.target);

                        children = children.concat(uikitUtil.toNodes(this$1.target.children).filter(function (el) { return !uikitUtil.includes(children, el); }));
                        ...
                        uikitUtil.addClass(this$1.target, targetClass);
                        children.forEach(function (el, i) { return propsFrom[i] && uikitUtil.css(el, propsFrom[i]); });
                        uikitUtil.css(this$1.target, 'height', oldHeight);
                        window.scroll(window.pageXOffset, oldScrollY);

                        uikitUtil.Promise.all(children.map(function (el, i) { return propsFrom[i] && propsTo[i]
                                ? uikitUtil.Transition.start(el, propsTo[i], this$1.animation, 'ease')
                                : uikitUtil.Promise.resolve(); }
                        ).concat(uikitUtil.Transition.start(this$1.target, {height: newHeight}, this$1.animation, 'ease'))).then(function () {
